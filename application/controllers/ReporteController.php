...
class ReporteController extends CI_Controller {
    ...
    public function exportarExcel() {
        ...
        $this->phpexcel->getActiveSheet()->getColumnDimension('F')->setWidth(35);
...
//        header('Pragma: public'); // HTTP/1.0
        ...
        $this->session->set_flashdata('excelok', ' archivo de excel creado correctamente por favor dirijase a disco local C carpeta files');
        $this->mostrarreporte();
    }
